...
export const Support = () => {
  return (
    <>
      <section id="support" className="signup-section" style={{minHeight: "65vh", display: "flex", alignItems: "center", justifyItems: "center"}}>
        <div className="container">
          <div className="row">
            <div className="col-md-10 col-lg-8 mx-auto text-center">

              <i className="far fa-heart fa-2x mb-2 text-white"></i>
              <h2 className="text-white mb-5">Your support allows us to stand up to legal repression and continue our
                groundbreaking work</h2>

              <a id="donateButton" href="#donate" className="btn btn-primary mx-auto donateButton" aria-label="Donate"
                 data-formId="8475">Donate</a>

            </div>
          </div>
        </div>
      </section>
      <Script id="funraise-script" strategy="afterInteractive" dangerouslySetInnerHTML={{__html: `
