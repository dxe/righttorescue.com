  ...
  return (
    <>
      ...
      <Details image="Conrad-Zoe-Rocky.jpeg">
        Following these arrests, the District Attorney filed charges against Zoe
        ...
        rescuing any more suffering animals. Zoe's preliminary hearing is
        scheduled for May 3. In California, all felony defendants have the right
        to a preliminary hearing where the State presents evidence before a
        judge who decides if there is enough evidence for each charge to proceed
        to trial.
      </Details>
