...
const Sunrise: NextPage = () => {
  return (
    <>
     ...
     Right after the sentencing hearing, three other DxE animal rescuers were arrested on felony warrants outside the courthouse. It seems there will be another #SonomaRescueTrial. {' '} <a href="https://www.vice.com/en/article/y3we9m/direct-action-everywhere-animal-rights-open-rescue-arrest?">Read the press here.</a> Wayne was released from jail on December 9th after serving almost half his sentence, as is typical in California.
      </Details>
