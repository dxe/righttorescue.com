    ...
    <>
      ...
      <Details>
        ...
        <p>
          ...
          after the release of DxE’s exposé. In January 2022, the day before
          Matt was set to start trial, all charges against him were dropped.
          This is a victory, but it is not the end. We are calling on Iowa
          county attorneys to prosecute Iowa Select Farms for animal cruelty and
          asking Governor Reynolds to end "ag-gag" laws that criminalize
          whistleblowing.
        </p>
      </Details>
      <Defendants>
